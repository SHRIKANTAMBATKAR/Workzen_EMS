    ...
    return (
        <DashboardLayout allowedRoles={["ANALYST"]}>
            <div className="space-y-8 animate-in fade-in duration-700">
                <div>
                    <h2 className="text-4xl font-bold tracking-tight">Academic Planning</h2>
                    <p className="text-slate-500 mt-2 text-lg">Managing batches and curriculum structuring.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="glass-card p-6 border-l-4 border-l-blue-500">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-sm font-semibold text-slate-500">Active Batches</p>
                    ...
                    <div className="glass-card p-6 border-l-4 border-l-orange-500">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-sm font-semibold text-slate-500">Pending Assignments</p>
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                    <div className="glass-card p-8">
                        <div className="flex justify-between items-center mb-8">
                            <h3 className="text-xl font-bold">Recent Batches</h3>
                            <button
                            ...
                            {activeBatches.map((batch, idx) => (
                                <div key={idx} className="space-y-3">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-sm font-bold text-slate-700">{batch.progress}%</span>
                                    </div>
                    ...
                    <div className="glass-card p-8">
                        <h3 className="text-xl font-bold mb-6">Quick Planning</h3>
                        <div className="grid grid-cols-1 gap-4">
                            <button
                                onClick={() => navigate("/analyst/batches")}
                                className="flex items-center gap-4 p-4 border border-slate-100 rounded-2xl hover:bg-slate-50 transition-colors group"
                            >
                                <div className="p-3 bg-accent text-white rounded-xl shadow-lg group-hover:scale-110 transition-transform">
                                    <BookOpen size={20} />
                                </div>
                                <div className="text-left">
                                    <p className="font-bold">Create New Batch</p>
                                    <p className="text-xs text-slate-500">Setup schedule and curriculum</p>
                                </div>
                            </button>
                            ...
                            >
                                ...
                                <div className="text-left">
                                    <p className="font-bold">Assign Students</p>
                                    <p className="text-xs text-slate-500">Link registered students to batches</p>
                                </div>
                            </button>
                        </div>
                    </div>
